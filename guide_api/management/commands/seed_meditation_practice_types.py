...
PRACTICE_TYPES = [
    ...
    },
    {
        ...
        "description": (
            ...
            "How to practice:\n"
            "\u2022 Mantra chanting is aloud \u2014 the vibration must fill the physical space around you.\n"
            "\u2022 Before chanting, breathe slowly into the lower abdomen. Let the belly expand below the navel. This is manipura chakra \u2014 the fire centre \u2014 and the true origin of mantra sound.\n"
            "\u2022 The navel is where Pashyanti vak lives: the vibratory impulse that precedes all audible sound. The mantra is born here, not at the throat.\n"
            "\u2022 The throat (vishuddhi) shapes and channels the sound but does not create it. When sound comes from the throat alone, it strains. When it rises from the navel, the throat relaxes.\n"
            "\u2022 Chant with full, unhurried voice. Feel the resonance in the chest, the skull, and the belly simultaneously.\n"
            "\u2022 This is exactly what the Dhrupad singers of Varanasi call pet ki awaaz \u2014 the voice from the belly. Their extraordinary resonance and endurance come from this principle.\n"
            "\u2022 Pronunciation matters \u2014 learn the correct syllables from the audio tracks here.\n"
