...
ITR_BUNDLES: dict[str, dict] = {
    "payg": {
        ...
        "credits": 1,
        "annual": False,
        "amount_paise": int(getattr(settings, "ITR_PAYG_AMOUNT_PAISE", 2000)),
        "amount_inr": int(getattr(settings, "ITR_PAYG_AMOUNT_PAISE", 2000)) // 100,
    ...
    "essentials": {
        ...
        "credits": 40,
        "annual": True,
        "amount_paise": int(getattr(settings, "ITR_ESSENTIALS_AMOUNT_PAISE", 50000)),
        "amount_inr": int(getattr(settings, "ITR_ESSENTIALS_AMOUNT_PAISE", 50000)) // 100,
        "per_export_inr": int(getattr(settings, "ITR_ESSENTIALS_AMOUNT_PAISE", 50000)) // 100 // 40,
