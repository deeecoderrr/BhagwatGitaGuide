...
urlpatterns = [
    ...
    path("checkout/<str:bundle>/init/", views.checkout_bundle_init, name="checkout_bundle_init"),
    path("success/", views.payment_success, name="payment_success"),
    path("webhook/razorpay/", views.razorpay_webhook, name="razorpay_webhook"),
    path("guest-checkout/", views.guest_checkout, name="guest_checkout"),
    path("guest-checkout/init/", views.guest_checkout_init, name="guest_checkout_init"),
